...
@Component({
  selector: 'app-dynamic-principles-card',
  standalone: true,
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @for (item of items(); track $index) {
          <div class="border border-[#d1e2ff] rounded-xl p-6 hover:shadow-lg transition-shadow bg-white">
            @if (item.icon) {
              <div class="text-[#6f93cd] mb-3">
...
export class DynamicPrinciplesCardComponent {
